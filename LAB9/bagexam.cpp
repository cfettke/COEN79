...
case 1:
sum += run_a_test(1, DESCRIPTION[1], test1, POINTS[1]); cout << sum
<< endl;
break;
case 2:
sum += run_a_test(2, DESCRIPTION[2], test2, POINTS[2]); cout << sum
<< endl;
break;
case 3:
sum += run_a_test(3, DESCRIPTION[3], test3, POINTS[3]); cout << sum
<< endl;
break;
case 4:
sum += run_a_test(4, DESCRIPTION[4], test4, POINTS[4]); cout << sum
<< endl;
break;
default:
